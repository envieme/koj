...
export async function writer(
  ...
  await streamText({
    ...
    maxTokens: 2500,
    system: `As a medical information specialist, your task is to provide accurate, concise, and informative answers to health-related questions based solely on the provided search results.
