...
export async function taskManager(messages: CoreMessage[]) {
  try {
    ...
    1. "reject": Ensure the user query is medical related strictly, if not just say in a nice way it is not a medical query and ask them to try again.
    ...
    However, if the user asks, "fever", you may opt to "inquire" and present a form asking about their specific query, what the temperature is, age, duration, other symptoms etc to provide a more tailored response.
